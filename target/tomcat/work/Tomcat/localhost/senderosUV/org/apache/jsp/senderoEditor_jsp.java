 ...
 * Generated at: 2024-06-14 19:24:37 UTC
...
public final class senderoEditor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/header_02.jsp", Long.valueOf(1718393075018L));
  }
...
if (usuario != null) {
    ...
    mensaje = "Sesión iniciada como invitado";
      ...
      out.write("\t<a class=\"w3-bar-item w3-right w3-text-gray\" >");
      out.print(mensaje);
      out.write("</a>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
 ...
 if (sendero != null) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t<label class=\"w3-text-blue\" for=\"zona\">Zona:</label>\r\n");
 ...
 if (z.get_id_zona()==zona) { 
      ...
      out.write("\t    \t\t<input class=\"w3-input w3-border w3-round-large\" id=\"year\" type=\"number\" value=\"");
      out.print(year);
      out.write("\" name=\"year\" >\r\n");
      out.write("\t    \t\t\r\n");
      out.write("\t    \t\t<label class=\"w3-text-blue\" for=\"url_recursos\">Ruta de logotipo:</label>\r\n");
      out.write("\t   \t\t\t<input class=\"w3-input w3-border w3-round-large\" id=\"url_recursos\" type=\"text\"  value=\"");
      ...
      out.write("\t\t<div class=\"w3-bar\">\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t\t<a href=\"#\" class=\"w3-bar-item w3-button\"> <b> Estaciones </b> </a>\r\n");
      out.write("\t\t  \r\n");
      ...
      out.print(id_sendero);
      out.write("\">\r\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"Agregar Estacion\" class=\"w3-bar-item w3-button w3-hover-green w3-right\">\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t \r\n");
      out.write("\t\t \t<div class=\"w3-col\" style=\"width:auto\">\r\n");
      out.write("\t\t \t\t<p><b> ");
...
out.print(estacion.get_descripcion());
      ...
      out.write("\t    \t\r\n");
      out.write("\t    \t//Obtengo mi formulario\r\n");
      out.write("\t        var form = document.getElementById('senderoForm');\r\n");
      out.write("\t    \t\r\n");
      out.write("\t        // Obtiengo los valores de los campos del formulario\r\n");
      out.write("\t        var form_nombre = form[\"nombre\"].value.trim();\r\n");
      out.write("\t        var form_sede = form[\"sede\"].value.trim();\r\n");
      out.write("\t        var form_year = form[\"year\"].value.trim();\r\n");
      out.write("\t        var form_url = form[\"url_recursos\"].value.trim();\r\n");
      out.write("\r\n");
      out.write("\t        // Reviso que los campos no esten vacios\r\n");
      out.write("\t        if (form_nombre == \"\") {\r\n");
      out.write("\t            alert(\"Escriba un nombre\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\r\n");
      out.write("\t        if (form_sede == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una sede\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_year == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una fecha\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_url == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una ruta\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
