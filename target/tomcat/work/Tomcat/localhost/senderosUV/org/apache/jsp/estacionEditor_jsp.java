 ...
 * Generated at: 2024-06-12 22:09:00 UTC
...
if (usuario != null) {
    ...
    mensaje = "Sesión iniciada como invitado";
      ...
      out.write("\t\t  \r\n");
      out.write("\t\t  <a href=\"#\" class=\"w3-bar-item w3-button\"> <b> Información del estación </b> </a>\r\n");
      out.write("\t\t  ");
 if (estacion != null) { 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t    \t\t<label class=\"w3-text-blue\" for=\"latitud\">Latitud:</label>\r\n");
      out.write("    \t\t\t<input class=\"w3-input w3-border\" id=\"latitud\" type=\"text\"  value=\"");
      out.print(latitud);
      out.write("\" maxlength=\"20\" name=\"latitud\">\r\n");
      out.write("    \t\t\t\r\n");
      out.write("\t    \t\t<label class=\"w3-text-blue\" for=\"longitud\">Longitud:</label>\r\n");
      ...
      out.write("\t\t<div class=\"w3-bar\">\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t\t<a href=\"#\" class=\"w3-bar-item w3-button\"> <b> Recursos </b> </a>\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t\t<form action=\"ServletRecursoCargar\" method=\"get\" accept-charset=\"UTF-8\">\r\n");
      out.write("\t\t\t\t<input id=\"id_recurso\" type=hidden name=\"id_recurso\" value=\"0\">\r\n");
      out.write("\t\t\t\t<input id=\"id_estacion\" type=hidden name=\"id_estacion\" value=\"");
      out.print(id_estacion);
      out.write("\">\r\n");
      out.write("\t\t\t\t<input id=\"id_sendero\" type=hidden name=\"id_sendero\" value=\"");
      out.print(id_sendero);
      out.write("\">\r\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"Agregar Recurso\" class=\"w3-bar-item w3-button w3-hover-green w3-right\">\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
...
out.print("#"+recurso.get_numero()+":");
      ...
      out.print(recurso.get_id_recurso());
      out.write("\">\r\n");
      out.write("\t\t\t\t<input id=\"id_estacion\" type=hidden name=\"id_estacion\" value=\"");
      out.print(id_estacion);
      out.write("\">\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<p><b> ");
out.print(recurso.get_tipo_recurso());
      out.write(" </b></p>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<p> ");
out.print(recurso.get_url());
      ...
      out.write("\t        var form_desc = form[\"descripcion\"].value.trim();\r\n");
      out.write("\t        var form_latitud = form[\"latitud\"].value.trim();\r\n");
      out.write("\t        var form_longitud = form[\"longitud\"].value.trim();\r\n");
      out.write("\r\n");
      ...
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_desc == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una descripcion\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_latitud == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una latitud\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_longitud == \"\") {\r\n");
      out.write("\t            alert(\"Escriba una longitud\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
