 ...
 * Generated at: 2024-06-15 22:26:12 UTC
...
if (usuario != null) {
 ...
 for (int i = 0; i < estaciones.size(); i++) { 
      ...
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    const pathCoordinates = [];\r\n");
      out.write("\r\n");
      ...
      out.write("    \t\r\n");
      out.write("    \t\r\n");
      out.write("\t\tconst contentString = `\r\n");
      out.write("        <div id=\"content\">\r\n");
      out.write("            <h2>${estacion.nombre}</h2>\r\n");
      out.write("            <p> ${estacion.descripcion}</p>\r\n");
      out.write("        </div>`;\r\n");
      out.write("          \r\n");
      out.write("        const infoWindow = new google.maps.InfoWindow({\r\n");
      out.write("          content: contentString,\r\n");
      out.write("          ariaLabel: estacion.nombre,\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("        const pin = new PinElement({\r\n");
      out.write("            glyph: `${estacion.numero}`,\r\n");
      out.write("            glyphColor: 'black',\r\n");
      out.write("            scale: 1.5,\r\n");
      out.write("            background: '#FFD700',\r\n");
      out.write("            borderColor: '#FF7F50',\r\n");
      out.write("            \r\n");
      out.write("          });\r\n");
      out.write("    \t\r\n");
      out.write("    \t\r\n");
      out.write("        const marker = new AdvancedMarkerElement({\r\n");
      out.write("            map: map,\r\n");
      out.write("            position: { lat: estacion.latitud, lng: estacion.longitud },\r\n");
      out.write("            title: estacion.nombre,\r\n");
      out.write("            content: pin.element,\r\n");
      out.write("            //content:priceTag,\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("        marker.addListener('click', () => {\r\n");
      out.write("            infoWindow.open({anchor: marker});\r\n");
      out.write("          });\r\n");
      out.write("        \r\n");
      out.write("     \t//Agregamos el punto al path para dibujar el sendero\r\n");
      out.write("        pathCoordinates.push({ lat: estacion.latitud, lng: estacion.longitud });\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    //A dibujar\r\n");
      out.write("    const lineSymbol = {\r\n");
      out.write("\t  path: google.maps.SymbolPath.FORWARD_ARROW,\r\n");
      out.write("\t  scale: 3,\r\n");
      out.write("\t  strokeColor: '#002D62'\r\n");
      out.write("\t};\r\n");
      out.write("    \r\n");
      out.write("    const trailPath = new google.maps.Polyline({\r\n");
      out.write("        path: pathCoordinates,\r\n");
      out.write("        icons: [{\r\n");
      out.write("            icon: lineSymbol,\r\n");
      out.write("            offset: '100%',\r\n");
      out.write("            repeat: '50px' // Repeat the arrow every 50 pixels\r\n");
      out.write("          }],\r\n");
      out.write("        geodesic: true,\r\n");
      out.write("        strokeColor: '#7CB9E8',\r\n");
      out.write("        strokeOpacity: 0.4,\r\n");
      out.write("        strokeWeight: 15,\r\n");
      out.write("    });\r\n");
      out.write("    trailPath.setMap(map);\r\n");
      out.write("    \r\n");
