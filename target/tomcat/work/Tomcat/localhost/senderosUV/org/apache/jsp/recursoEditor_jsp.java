 ...
 * Generated at: 2024-06-12 22:15:36 UTC
...
public final class recursoEditor_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (usuario != null) {
    ...
    mensaje = "Sesión iniciada como invitado";
      ...
      out.write("\t\t  \r\n");
      out.write("\t\t  <a href=\"#\" class=\"w3-bar-item w3-button\"> <b> Información del recurso </b> </a>\r\n");
      out.write("\t\t  ");
 if (recurso != null) { 
      out.write("\r\n");
      ...
      out.print( (recurso != null) ? "Actualizar" : "Guardar" );
      out.write("</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\r\n");
      ...
      out.write(" \t\t\r\n");
      out.write(" \t\t\t<p></p>\r\n");
      out.write("\t\t\t<form class=\"w3-container\" method=\"post\" accept-charset=\"UTF-8\" id=\"recursoForm\">\r\n");
      out.write("\t\r\n");
      out.write("\t    \t\t<input id=\"id_recurso\" type=hidden name=\"id_recurso\" value=\"");
      out.print(id_recurso);
      out.write("\"> \r\n");
      out.write("\t    \t\t<input id=\"id_estacion\" type=hidden name=\"id_estacion\" value=\"");
      out.print(id_estacion);
      out.write("\"> \r\n");
      out.write("\t    \t\t<input id=\"id_senero\" type=hidden name=\"id_sendero\" value=\"");
      out.print(id_sendero);
      out.write("\">    \t\t\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t\t<label class=\"w3-text-blue\" for=\"nombre\">Numero de recurso:</label>\r\n");
      out.write("\t   \t\t\t<input class=\"w3-input w3-border w3-round-large\" id=\"numero\" type=\"number\" value=\"");
      out.print(numero);
      out.write("\" name=\"numero\">\r\n");
      out.write("\t   \t\t\t\r\n");
      out.write("\t   \t\t\t<label class=\"w3-text-blue\" for=\"sede\">URL o ruta del recurso:</label>\r\n");
      out.write("\t   \t\t\t<input class=\"w3-input w3-border w3-round-large\" id=\"url\" type=\"text\" value=\"");
      out.print(url);
      out.write("\" maxlength=\"100\" name=\"url\" >\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t<label class=\"w3-text-blue\" for=\"fabricante\">Tipo de recurso:</label>\r\n");
      out.write("\t   \t\t\t<select class=\"w3-input w3-border w3-round-large\" id=\"id_tipo_recurso\" name=\"id_tipo_recurso\">\r\n");
      out.write("\t\t\t\t\t\t");
 for (TipoRecursoJB tr : tipo_recursos) { 
      out.write("\r\n");
      out.write("\t        \t\t\t\t\t\t<option value=\"");
      out.print( tr.get_id_tipo_recurso() );
      out.write('"');
      out.write(' ');
 if (tr.get_id_tipo_recurso()==id_tipo_recurso) { 
      out.write(" selected ");
 } 
      out.write(">\r\n");
      out.write("\t            \t\t\t\t\t\t");
      out.print( tr.get_tipo() );
      out.write("\r\n");
      out.write("\t        \t\t\t\t\t\t</option>\r\n");
      out.write("\t    \t\t\t\t\t\t");
 } 
      ...
      out.write("\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<label class=\"w3-text-blue\" for=\"sede\">Créditos:</label>\r\n");
      out.write("\t   \t\t\t<input class=\"w3-input w3-border w3-round-large\" id=\"creditos\" type=\"text\" value=\"");
      out.print(creditos);
      out.write("\" maxlength=\"100\" name=\"creditos\" >\r\n");
      out.write("\t\t\t\t \t\t\r\n");
      out.write("\t\r\n");
      out.write("\t    \t</form>\r\n");
      out.write("    \t\t<p> </p>\r\n");
      ...
      out.write("\t        var form = document.getElementById('recursoForm');\r\n");
      out.write("\t        \r\n");
      out.write("\t        // Obtiengo los valores de los campos del formulario\r\n");
      out.write("\t       \tvar form_numero = form[\"numero\"].value.trim();\r\n");
      out.write("\t        var form_url = form[\"url\"].value.trim();\r\n");
      out.write("\t        var form_creditos = form[\"creditos\"].value.trim();\r\n");
      out.write("\t        \r\n");
      out.write("\t        // Reviso que los campos no esten vacios\r\n");
      out.write("\t        if (form_numero == \"\") {\r\n");
      out.write("\t            alert(\"Escriba un numero\");\r\n");
      ...
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (form_creditos == \"\") {\r\n");
      out.write("\t            alert(\"Escriba los creditos\");\r\n");
      out.write("\t            return false;\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
      out.write("\t        if (action === 'guardar') {\r\n");
      out.write("\t            form.method = 'post';\r\n");
      out.write("\t            form.action = 'ServletRecursoGuardar';\r\n");
      out.write("\t        } else if (action === 'borrar') {\r\n");
      out.write("\t            form.method = 'get';\r\n");
      out.write("\t            form.action = 'ServletRecursoBorrar';\r\n");
      out.write("\t        }\r\n");
      out.write("\t        \r\n");
